<template>
  <div style="position:relative;text-align:left;height:auto">
    ...
    />
    <div
      style="position:absolute;left:16vw;top:3vw;color:#505050;font-size:3.5vw;"
    >
      {{ msg[index].username }}
    </div>
    <div
      style="position:absolute;left:16vw;top:8.5vw;color:#616161;font-size:3vw;"
    >
      {{ msg[index].date }}
    </div>
    <Imagev
      @click.native="like"
      style="position:absolute;right:3vw;top:0.5vw;margin-left:3vw;margin-top:5vw;"
      :src="thumb_url"
      width="4vw"
      height="4vw"
    />
    <div
      :id="generateID(index)"
      style="position:absolute;right:9.5vw;top:5.2vw;color:#616161;font-size:3.5vw;"
    >
      {{ likes }}
    </div>
    <div
      style="margin-right:3vw;margin-left:16vw;margin-bottom:3vw;color:#202020;font-size:3.5vw;"
    >
      {{ msg[index].content }}
    </div>
