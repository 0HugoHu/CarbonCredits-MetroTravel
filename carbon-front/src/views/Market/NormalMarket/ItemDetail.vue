<template>
  <div v-if="item">
    ...
    <van-cell-group title="商品信息" class="item-detail-info item-detail-block">
      <van-cell title="品牌" :value="item.detail.brand" />
    </van-cell-group>
    ...
    >
      <van-cell title="产地/厂家" :value="item.detail.manufacturer" />
      <van-cell title="包装内容" :value="item.detail.contents"></van-cell>
      <van-cell title="其他说明" :value="item.detail.additional"></van-cell>
    </van-cell-group>
    <div class="item-bottom-bar">
      <van-goods-action>
        <van-goods-action-icon to="/normal_market/kefu" icon="chat-o" text="客服" />
